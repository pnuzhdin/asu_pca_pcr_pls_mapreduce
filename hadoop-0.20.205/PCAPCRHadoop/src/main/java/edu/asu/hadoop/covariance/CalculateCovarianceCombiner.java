...
/**
 * Calculate covariance matrix for Hadoop 0.20.205 (Combiner)
 * @author Pavel Nuzhdin <pnzhdin@gmail.com>
 */
public class CalculateCovarianceCombiner
    ...
    private DoubleArrayWritable combinerOutArray = new DoubleArrayWritable();
    ...
    public void reduce(
        ...
        combinerOutArray.set(outArray);
        context.write(position, combinerOutArray);
    }
